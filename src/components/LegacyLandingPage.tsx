...
import { Sparkles, Loader2, BookOpen, PenTool, Globe, GraduationCap, Heart, Rocket } from 'lucide-react';
...
export const LandingPage = ({ onEnter, onNavigate }: LandingPageProps) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 w-full py-24 px-6 md:px-12 bg-[#050510] border-t border-white/5">
            ...
            <div id="about-us" className="relative z-10 w-full py-24 px-6 md:px-12 bg-[#050510] border-t border-white/5 bg-gradient-to-b from-transparent to-purple-900/5">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="font-serif text-lg md:text-xl text-white/70 leading-relaxed mb-12">
                        Skywhale. vznikl z jednoduché myšlenky: <span className="text-purple-300 italic">každý má v sobě příběh, který stojí za to vyprávět.</span><br /><br />
                        Spojili jsme nejmodernější AI technologii s láskou k literatuře, abychom odstranili bariéry mezi vaší fantazií a hotovou knihou.
                        Jsme malý tým nadšenců, kteří věří, že kreativita je tou nejcennější lidskou vlastností, a naším cílem je dát každému nástroje k jejímu vyjádření.
                    </p>
            ...
            <footer className="relative z-10 w-full py-12 px-6 bg-[#050510] border-t border-white/5 flex flex-col items-center">
                ...
                <div className="text-center">
                    <div className="font-title text-2xl text-white/20 mb-4 tracking-tighter">Skywhale.</div>
                    <p className="text-white/10 text-xs uppercase tracking-[0.2em]">
